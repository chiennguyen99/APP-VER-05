...
namespace VER_CONNECT.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var User = db.AspNetUsers.ToList().Find(x => x.Email == model.Email); 
            ...
            switch (result)
            {
                ...
                case SignInStatus.RequiresVerification:
                    ModelState.AddModelError("", "You can check email comfirm account to login!");
                    return View(model); 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid && em != null)
            {
                ...
                var user = new ApplicationUser { UserName = un, Email = model.Email, Id = model.ID };
